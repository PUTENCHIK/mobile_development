...
import com.example.fragmentweatherapp.databinding.FragmentWeatherFullBinding
...
class WeatherFull : Fragment() {
    ...
    lateinit var binding: FragmentWeatherFullBinding

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        binding = FragmentWeatherFullBinding.inflate(layoutInflater)
        val activity = requireActivity() as MainActivity
        val weatherFull = binding.root
